...
As we can see in figure~\ref{fig:modularity_paradigm} we can accept our Hypothesis. This is something expected as OOP paradigm has this modularity philosophy (classes, objects, setters, getters,...) in its core design principles. 

\subsection{Hypothesis 3}

As we can see in this figure~\ref{fig:fp_log_lines_mod} and~\ref{fig:fp_log_lines_mod} we have to reject our Hypothesis as we can't see that there exist a clear relationship between this 2 variables. It is enough to check visually the images to make this statement.
