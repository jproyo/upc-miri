...
\begin{listing}[H]
  \inputminted[firstline=30, lastline=50, linenos, breaklines]{haskell}{../src/SAT/Solver.hs}
...
\begin{listing}[H]
  \inputminted[firstline=110, lastline=116, linenos, breaklines]{haskell}{../src/SAT/Solver.hs}
  \caption{Extracted from source code src/SAT/Solver.hs}
  \label{src:sat:6}
\end{listing}
...
\begin{listing}[H]
  \inputminted[firstline=55, lastline=73, linenos, breaklines]{haskell}{../src/SAT/Solver.hs}
  \caption{Extracted from source code src/SAT/Solver.hs}
  \label{src:sat:7}
\end{listing}
