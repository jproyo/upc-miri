...
As we can see in figure~\ref{fig:modularity_paradigm} we can accept our Hypothesis. FP avarage modularity is 0.5097 whereas OOP avarage modularity is 0.7256. This is an increase of 42\%.This is something expected as OOP paradigm has this modularity philosophy (classes, objects, setters, getters,...) in its core design principles. 
